...
public String expenses() { return "expenses"; }
...
public String savings() { return "savings"; }
...
@GetMapping("/sip-calculator-page")
public String sipCalculator() { return "sip-calculator"; }

@GetMapping("/loan-calculator-page")
public String loanCalculator() { return "loan-calculator"; }

@GetMapping("/tax-calculator-page")
public String taxCalculator() { return "tax-calculator"; }
