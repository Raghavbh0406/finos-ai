...
async function loadDashboard() {
    ...
    income.reduce(
        ...
        document.getElementById("totalInvestments").innerText =
            "₹" + totalInvestments;
        ...
        document.getElementById("investmentCount").innerText =
            investments.length;

        document.getElementById("goalCount").innerText =
            goals.length;

        document.getElementById("portfolioGain").innerText =
            "₹" + portfolioGain;
        ...
        // INSIDE loadDashboard(), AFTER portfolioGain calculation,
// add this block BEFORE renderExpenseChart(...)
...
totalBudgets === 0
? 0
: (totalExpenses / totalBudgets) * 100;
...
document.getElementById("savingsProgress").innerText =
progress.toFixed(1) + "%";

document.getElementById("budgetUtilization").innerText =
budgetUtilization.toFixed(1) + "%";

document.getElementById("healthScore").innerText =
Math.min(health, 100) + "/100";
